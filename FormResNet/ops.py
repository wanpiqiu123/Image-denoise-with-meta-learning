...
def sobel(inputs):
    ...
    filter_h = tf.reshape(tf.constant([[[-1, 0, 1], [-2, 0, 2], [-1, 0, 1]],[[-1, 0, 1], [-2, 0, 2], [-1, 0, 1]],[[-1, 0, 1], [-2, 0, 2], [-1, 0, 1]]], dtype=tf.float32), [3, 3, 3, 1])
    filter_V = tf.reshape(tf.constant([[[1, 2, 1], [0, 0, 0], [-1, -2, -1]],[[1, 2, 1], [0, 0, 0], [-1, -2, -1]],[[1, 2, 1], [0, 0, 0], [-1, -2, -1]]], dtype=tf.float32), [3, 3, 3, 1])
